...
export default function MobileFrame({ children, theme, isWide = false }: MobileFrameProps) {
  return (
    <div
    ...
    >
      {/* Immersive Smartphone Bezel container with dynamic expansion */}
      <div
        id="android-device-wrapper"
        className={`w-full ${
          isWide ? "sm:max-w-[960px]" : "sm:max-w-[450px]"
        } sm:h-[840px] max-h-screen sm:rounded-[36px] bg-white dark:bg-[#09090b] border-0 sm:border-8 border-slate-900 dark:border-zinc-800 flex flex-col shadow-2xl overflow-hidden relative transition-all duration-500 ease-in-out sm:ring-4 sm:ring-slate-900/10 dark:sm:ring-zinc-800/20`}
      >
